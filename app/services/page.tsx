      ...
      <header className="px-8 h-24 flex items-center border-b bg-white fixed w-full z-10 shadow-sm">
        <Link className="flex items-center justify-center" href="/">
          <div className="h-16 w-auto">
            <svg viewBox="0 0 200 80" xmlns="http://www.w3.org/2000/svg" className="h-full w-auto">
              <rect width="100%" height="100%" fill="white" />
              <path d="M20 20 H180 V60 H20 Z" fill="#1A85B8" />
              <text x="40" y="45" fill="white" fontFamily="Arial" fontSize="18" fontWeight="bold">
                TrueClaim
              </text>
            </svg>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="bg-white p-3 rounded-lg inline-block mb-4">
                <svg viewBox="0 0 200 80" xmlns="http://www.w3.org/2000/svg" className="h-16 w-auto">
                  <rect width="100%" height="100%" fill="white" />
                  <path d="M20 20 H180 V60 H20 Z" fill="#1A85B8" />
                  <text x="40" y="45" fill="white" fontFamily="Arial" fontSize="18" fontWeight="bold">
                    TrueClaim
